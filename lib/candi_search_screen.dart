...
class CandiSearchScreen extends StatefulWidget {
  @override
  _CandiSearchScreenState createState() => _CandiSearchScreenState();
}

class _CandiSearchScreenState extends State<CandiSearchScreen> {
